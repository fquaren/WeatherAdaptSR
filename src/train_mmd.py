...
def objective_mmd(trial, model, num_epochs, cluster, cluster_names, config, device, device_data, augment):
...
def train_model_mmd(model, excluding_cluster, num_epochs, source_train_loader, target_train_loader, source_val_loader, config, device, save_path):
    ...
    if os.path.exists(log_file):
        ...
        with open(log_file, "w") as f:
            f.write("Epoch,Train Loss,Train MMD Loss,Lambda MMD,Validation Loss,Learning Rate,Epoch Time\n")
