...
python /work/FAC/FGSE/IDYST/tbeucler/downscaling/fquareng/WeatherAdaptSR/cross-evaluate.py --device "cuda" --exp_path "/scratch/fquareng/experiments/cross-val-v3/20iq"
