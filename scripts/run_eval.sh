...
micromamba run -n dl python /work/FAC/FGSE/IDYST/tbeucler/downscaling/fquareng/WeatherAdaptSR/cross-evaluate-mmd.py --device "cuda" --exp_path /scratch/fquareng/experiments/UNet_MMD/g5r6

# # Evaluate all experiments in the folder
# base_path=/scratch/fquareng/experiments/UNet_mdan
...
#     micromamba run -n dl python /work/FAC/FGSE/IDYST/tbeucler/downscaling/fquareng/WeatherAdaptSR/cross-evaluate-mmd.py --device "cuda" --exp_path $folder
